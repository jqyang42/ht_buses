...
urlpatterns = [
    ...
    path('users/edit/validate-email', user_edit.valid_email_edit, name="validate_email_edit"),
     path('users/create/validate-email', user_create.valid_email_create, name="validate_email_create"),
    ...
    path('routeplanner/edit', student_route_edit.student_route_edit, name='student_route_edit')
]