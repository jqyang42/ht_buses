...
urlpatterns = [
    ...
    path('api/can-delete-user', parent_dashboard.can_delete_user, name= "delete"),
    ...
    path('api/dashboard/students/stops', parent_student_stop.parent_student_stops, name='parent_student_stops'),
