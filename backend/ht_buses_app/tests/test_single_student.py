...
class Test_students(APITestCase):
    ...
    def test_student_creation(self):
        ...
        assert Student.objects.filter(first_name = "Henry", last_name = "Smith", school_id = school).count() > 0
    ...
    def test_student_edit(self):
        ...
        student = Student.objects.create(first_name="Hello", last_name="Kitty", school_id=school, user_id=user, student_school_id= 9876, route_id=route)
        ...
        assert Student.objects.filter(first_name = "Not Henry", last_name = "Not Smith", student_school_id = 1234).count() > 0
