...
class Test_routes(APITestCase):
    ...
    def make_route():
        route  = Route.objects.create(name = "Route Star", school_id = School.objects.get(name = "East Middle School") , description = "Here is a description")
        return route
    ...
    def test_route_creation(self):
        ...
        assert Route.objects.get(name = "Route 89") is not None
    ...
    def test_route_edit(self):
        ...
        assert Route.objects.get(name = "Route Star") is not None
        ...
        route = Route.objects.get(name = "Star Route")
